...
if(strlen($_SESSION['alogin'])==0 and strlen($_SESSION['mainadmin']) == 0)
	{	
...
{				?>		
						  <tr>
							...
							<td><a href="adminupdate-package.php?pid=<?php echo htmlentities($result->pid);?>"><?php echo htmlentities($result->pckname);?></a></td>
...
<td>
	...
	echo htmlentities($result->payed_status);
...
<?php } else if ($result->status==1){?>
	<td>Confirmed</td>
<?php } else {?>
<td><a href="adminmanage-bookings.php?bkid=<?php echo htmlentities($result->bookid);?>" onclick="return confirm('Do you really want to cancel booking')" >Cancel</a> / <a href="adminmanage-bookings.php?bckid=<?php echo htmlentities($result->bookid);?>" onclick="return confirm('booking has been confirm')" >Confirm</a></td>
<?php }?>
