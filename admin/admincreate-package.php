...
$sql="INSERT INTO tbltourpackages(PackageName,PackageType,PackageLocation,PackagePrice,PackageFetures,tourduration,PackageDetails,PackageImage) VALUES(:pname,:ptype,:plocation,:pprice,:pfeatures,:tduration,:pdetails,:pimage)";
...
<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="tourduration" id="packageprice" placeholder="Tour duration in Days(A number is requiered!)" required>
									</div>
								</div>	
