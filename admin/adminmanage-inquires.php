...
{				?>		
						  <tr>
							...
							<td width="50"><?php echo htmlentities($result->pkgid);?></a></td>
...
<td><a href="adminmanage-inquires.php?eid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want to read')" >Pending</a>
</td>
<?php } ?>
</tr>
						 <?php } }?>
