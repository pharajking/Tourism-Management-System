...
$sql="INSERT INTO  tblenquiry(FullName,EmailId,MobileNumber,Subject,Description, pkgid) VALUES(:fname,:email,:mobile,:subject,:description,:pkgid)";
...
<b>Mobile No</b>  <input type="text" name="mobileno" class="form-control" id="mobileno" maxlength="10" placeholder="10 Digit mobile No" required="">
	...
	<p style="width: 350px;">
<b>Package Number</b>  <input type="text" name="subject" class="form-control" id="subject"  placeholder="Subject" required="" value="<?php echo htmlentities($pkgid)?>">
	</p> 
